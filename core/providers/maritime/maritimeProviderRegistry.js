...
(function () {
  ...
  var PROVIDERS = [
    ...
    },
    {
      ...
      proxyFn:          '/.netlify/functions/vessel-finder',
      notes:            'AIS + Voyage + Master + PortCalls via unified /vessels endpoint. VESSELFINDER_API_KEY env var required. Viewport-aware bbox polling: 30s zoomed, 60s regional, skipped at global zoom. extradata param for voyage/master enrichment. Source-namespaced entries coexist with Digitraffic.',
    },
    {
