...
// Supplemental aircraft ingestion — adsb.lol via Netlify proxy.
//
// Architecture:
...
(function () {
  ...
  // ── Lifecycle ─────────────────────────────────────────────────────────────────
  function start() {
    if (_suppTimer) return; // already running
